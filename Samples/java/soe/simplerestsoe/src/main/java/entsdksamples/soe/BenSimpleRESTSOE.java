...
@ArcGISExtension
@ServerObjectExtProperties(displayName = "Ben Simple REST SOE",
        description = "Ben Simple REST SOE",
        properties = "" ,
        allSOAPCapabilities = "" ,
        defaultSOAPCapabilities = "" ,
        supportsSharedInstances = true)

public class BenSimpleRESTSOE implements IServerObjectExtension, IRESTRequestHandler, IObjectActivate
{
    ...
    public BenSimpleRESTSOE()throws Exception{
        super();
    }
    ...
    private byte[] getRootResource() throws Exception {
        ...
        json.put(
                "description",
                "BenSimpleRESTSOE SOE with 1 sub-resource called \"layers\" and 1 operation called \"getLayerCountByType\".");
        json.put(
                "usage",
    ...
    public String getSchema()throws IOException,AutomationException{
        try{
            JSONObject BenSimpleRESTSOE = ServerUtilities.createResource("BenSimpleRESTSOE",
                    "BenSimpleRESTSOE description",false,false);
            ...
            BenSimpleRESTSOE.put("resources", _subResourcesArray);

            JSONArray _OpArray = new JSONArray();
            _OpArray.put(ServerUtilities.createOperation("getLayerCountByType",
                    "type", "json", false));
            BenSimpleRESTSOE.put("operations", _OpArray);

            return BenSimpleRESTSOE.toString();
